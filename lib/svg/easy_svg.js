...
var SVGParser = require('convertpath')
...
exports.normalizeSvg = function(svg, options) {
  var parse = SVGParser.parseStr(svg, {
    plugins: [
      {
  ...
  var svgStr = parse.toSimpleSvg()

  var svgDocNode = new DOMParser().parseFromString(svgStr, 'application/xml')
